# Generated by Django 4.1.13 on 2024-10-25 12:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('apis_ontology', '0042_alter_conceptualobject_created_by_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReifiedRelation',
            fields=[
        ...
        migrations.CreateModel(
            name='PersonWithProxy',
            fields=[
                ('reifiedrelation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='apis_ontology.reifiedrelation')),
            ],
            options={
                'verbose_name': 'Person represented by Proxy',
            },
            bases=('apis_ontology.reifiedrelation',),
        ),
    ]
